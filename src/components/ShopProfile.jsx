...
import EditShopProfile from './EditForms/EditShopProfile';
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.buttons}>
        ...
        <span>Manage PAN & GSTIN (not mandatory)</span>
        ...
        <span>LICENSE (mandatory for certain products ) optional</span>

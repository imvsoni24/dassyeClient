...
import EditSalesProfile from './EditForms/EditSalesProfile';
import PanAadhaarForm from './BusinessForms/PanAadhaarForm';
import EditPanAadhaar from './EditForms/EditPanAadhaar';
...
const SalesProfile = () => {
  ...
  const handleLogout = ()=>{
    localStorage.removeItem("Sales id")
    navigate("/sales")
  }
  return (
    <div className={styles.container}>
      <h1>Admin (Sales Person) Profile </h1>
      ...
      <div className={styles.buttons}>
        <span>Primary Address ( mandatory )</span>
        ...
        <span>Manage Proof(not mandatory)</span>
        <button onClick={() => handleButtonClick('panAadhaar')}>
        <div>
        <img src="https://www.professionalutilities.com/images/17.jpg" alt="" />
        <h3>Add Aadhaar,PAN</h3>
        </div>
        <img  src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/Dark_blue_right_arrow.svg/800px-Dark_blue_right_arrow.svg.png" alt="" />
        </button>
        {activeForm === 'panAadhaar' && <PanAadhaarForm />}
      </div>
      </div>
       : 
      ...
      {activeForm === 'profile' && <EditSalesProfile />}
      <button  onClick={() => handleButtonClick('Details')}>
        <img  src="https://cdn-icons-png.flaticon.com/512/1933/1933920.png" alt="" />
        <div>
        <p>Sales profile</p>
        <p>Modify your sales profile (PAN/Aadhaar)</p>
        </div>
        <img  src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/Dark_blue_right_arrow.svg/800px-Dark_blue_right_arrow.svg.png" alt="" />
      </button>
      {activeForm === 'Details' && <EditPanAadhaar />}
      <button onClick={() => handleButtonClick('address')}>
